...
import com.esiea.issofeapp.data.api.MovieDbClient
import com.esiea.issofeapp.data.api.MovieDbInterface
import com.esiea.issofeapp.data.api.POSTER_BASE_URL
...
class SingleMovie : AppCompatActivity() {
    ...
    private lateinit var movieRepository: MoviesDetailsRepository
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        movieRepository = MoviesDetailsRepository(apiService)
